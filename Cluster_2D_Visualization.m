% Use the k-means function on an example with randomly created
...
% create a random matrix of size 2-by-numP with row 1/2 (x/y coordiante) ranging in [minX,maxX]/[minY,maxY]
xP = xMax * rand(1,numP);
yP = yMax * rand(1,numP);
points = [xP; yP];
